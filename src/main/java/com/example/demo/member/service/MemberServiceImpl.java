...
public class MemberServiceImpl implements MemberService {
    ...
    public Boolean register(MemberRequestForm requestForm) {
        ...
        final Member member = requestForm.toMember(passwordEncoder.encode(requestForm.getPassword()));
    ...
    public MemberLoginResponseForm login(MemberLoginRequest request) {
        ...
        log.info("encoded pw : " + member.getPassword());
        log.info("raw pw : " + request.getPassword());
